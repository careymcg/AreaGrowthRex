...
Read in and plot individual runs to check and have a record

# ```{r plotruns, echo=FALSE}
...
```{r plot ages, echo = FALSE}
plot_length_compare(ssruns = MasterList, narea = 1, mnames = Mlabels,comptype = "age")
```

Figure 2. Fits (lines) to female and male fishery age composition with data aggregated by year (shaded regions) for the one area model with fishery ages included in model inputs.
