...
#CHECK DEFINITION OF SPRratio_ in DERIVED QUANTITIES! I think it's 1-SPR. Does Ian skip plotting the last year? Should I?
fi_plot<-plot_one_minus_spr(ssruns = MasterList,mlabel = Mlabels,showxlabel = TRUE,showlegend = "yes")


bigfig<-(ssbplot/recplot/fi_plot)
